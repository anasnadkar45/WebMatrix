...
// Define types for the SocialIcon props
interface SocialIconProps {
  Icon: React.ElementType; // This type allows any valid React component to be passed as an icon
  href: string;
  label: string;
}

// SocialIcon component with typed props
    ...
    >
      <div className="relative bg-background/80 backdrop-blur-md p-3 rounded-full shadow-lg border border-white/60">
        <div className="flex sm:flex-col items-center justify-between sm:gap-4">
          <SocialIcon
            Icon={MdEmail}
            href="mailto:webmetrix45@gmail.com"
            label="Email"
          />
          <SocialIcon
            Icon={Twitter}
            href="https://twitter.com/anasnadkar45"
            label="Twitter"
          />
          <SocialIcon
            Icon={Instagram}
            href="https://www.instagram.com/anasnadkar45/profilecard/?igsh=MTM4dWoxOGdua3U5MA=="
            label="Instagram"
          />
          <SocialIcon
            Icon={Linkedin}
          ...
          <SocialIcon
            Icon={Github}
            href="https://github.com/anasnadkar45/"
            label="GitHub"
          />
        </div>
        {/* Inner shadow effect */}
